                ...
                <form action="{{ route('mahasiswa.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="nim" value="{{ old('nim') }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_mahasiswa" value="{{ old('nama_mahasiswa') }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>

                        <div>
                            <label class="block font-medium text-sm text-gray-700">Tempat Lahir</label>
                            <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>

                        <div>
                            <label class="block font-medium text-sm text-gray-700">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="program_studi" value="{{ old('program_studi') }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>

                        <div>
                            <label class="block font-medium text-sm text-gray-700">Nomor HP</label>
                            <input type="text" name="nomor_hp" value="{{ old('nomor_hp') }}" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="alamat" rows="3" class="w-full border-gray-300 rounded-md shadow-sm" required>{{ old('alamat') }}</textarea>
                    </div>
